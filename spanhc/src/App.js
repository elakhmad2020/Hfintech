...
function Sidebar({ active, onNav, userPhoto, userName }) {
  const sections = [
  ...
  return (
    <div className="sidebar">
      <div className="sidebar-logo">
        <div className="sidebar-logo-icon">SPAN</div>
    ...
    <>
      ...
      <div className="app">
        <div className="main-layout">
          <Sidebar active={page} onNav={setPage} userPhoto={userPhoto} userName={userName} />
